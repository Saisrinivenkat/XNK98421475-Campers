...
function openModal() {
  ...
  btn.onclick = function () {
    ...
    $("#myframe").contents().find("html head").append(`
    ...
    $("#myframe").contents().find("html body").append(`
          ...
          <div class="if container" style="width: 90%;position: absolute;border: 1px solid #f5f5f5;border-radius: 5px;box-shadow: 2px 5px 10px #e4e4e4;">
              <div class="if nav">
                  ...
                  <button data-tooltip="Pdf" id="pdf" class="tooltip button -regular">Save as PDF</button>
    ...
    $("#myframe")
      .contents()
      .find("html body button#pic")
      .on("click", (event) => {
        var player = $("iframe#my-video-frame")
          .contents()[0]
        ...
        $("#myframe")
          .contents()
          .find("html body div.if.container iframe")
          .contents()[0]
          .execCommand("insertImage", false, base64Canvas);
      });
  };
